    ...
    <footer className="border-t border-border bg-card mt-20">
      <div className="container py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="font-bold uppercase text-sm mb-3 text-foreground">Navigazione</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/chi-siamo" className="text-sm text-muted-foreground hover:text-accent transition-colors">
                  Chi Siamo
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="font-bold uppercase text-sm mb-3 text-foreground">Contatti</h3>
