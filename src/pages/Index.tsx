    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="container relative z-10 text-primary-foreground px-4 text-center flex flex-col items-center justify-center">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold uppercase drop-shadow-2xl tracking-tight mb-6">
              Materia <span className="text-accent">PRIMA</span>
            </h1>
            <div className="space-y-4 max-w-3xl mx-auto">
              <p className="text-xl md:text-2xl lg:text-3xl font-semibold drop-shadow-lg">
                Il blog di 2D Sviluppo Immobiliare
              </p>
              <p className="text-base md:text-lg lg:text-xl drop-shadow-md font-light opacity-90">
                Innovazione, sostenibilità e visione nel settore edilizio
              </p>
            </div>
            <Link to="/chi-siamo" className="inline-block mt-10">
              <Button size="lg" className="uppercase font-bold text-base md:text-lg px-8 md:px-10 py-5 md:py-6 bg-accent hover:bg-accent/90 text-accent-foreground shadow-xl transition-transform hover:scale-105">
